...
![Bi_LSTM_average_encoder_output](./image/BIdirectional_LSTM+Average_Encoder_Output.PNG = 150x)

    b. Bi_LSTM_luong_attention.py
![Bi_LSTM_luong_attention](./image/BIdirectional_LSTM+Luong_Attention.PNG = 150x)
   
    c. Bi_LSTM.py
![Bi_LSTM](./image/BIdirectional_LSTM.PNG = 150x)